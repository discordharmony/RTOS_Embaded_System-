...
_not_first_int:
#endif
                ldi     R16,((65536-(CPU_CLOCK_HZ/OS_TICKS_PER_SEC/1024))>>8)
                                                    ; Reload timer to overflow at a rate of OS_TICKS_PER_SEC
                out     _SFR_IO_ADDR(TCNT1H),R16    ; at a prescaler of 1024 and CPU_CLOCK_HZ AVR clock
                ldi     R16,((65536-(CPU_CLOCK_HZ/OS_TICKS_PER_SEC/1024))&0xFF)
